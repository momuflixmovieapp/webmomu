...
class UsersRecord extends FirestoreRecord {
  ...
  bool hasRefferalcode() => _refferalcode != null;
  ...
  // "watching" field.
  int? _watching;
  int get watching => _watching ?? 0;
  bool hasWatching() => _watching != null;
  ...
  void _initializeFields() {
    ...
    _refferalcode = snapshotData['refferalcode'] as String?;
    _subscription = snapshotData['subscription'] as String?;
    _startdate = snapshotData['startdate'] as DateTime?;
    _userbalance = castToType<int>(snapshotData['userbalance']);
    _watching = castToType<int>(snapshotData['watching']);
  }
