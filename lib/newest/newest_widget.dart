...
import 'newest_model.dart';
export 'newest_model.dart';
...
class _NewestWidgetState extends State<NewestWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewestModel());
        ...
        body: SafeArea(
          ...
          child: Container(
            ...
            child: FlutterFlowWebView(
              content: 'https://server.momuflix.cloud/newest.html',
              bypass: false,
